                ...
                {filteredHistory.length === 0 ? (
                    ...
                    filteredHistory.map((item) => {
                        ...
                        return (
                            <div 
                                key={uniqueId}
                                className={`bg-white rounded-[32px] border-2 transition-all duration-300 overflow-hidden ${
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-0.5">
                                            <span className="text-stone-400 text-xs font-black uppercase tracking-wider">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="hidden md:flex -space-x-3 overflow-hidden">
                                            ...
                                            {item.actionLogs.flatMap((al: any) => al.images).length > 3 && (
                                                <div className="flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-white bg-stone-100 text-[10px] font-bold text-stone-500">
                                                    +{item.actionLogs.flatMap((al: any) => al.images).length - 3}
                                                </div>
                                            )}
                                        </div>

                                        <div className={`p-2 rounded-xl transition-colors ${isExpanded ? "bg-emerald-50 text-emerald-600 rotate-180" : "bg-stone-50 text-stone-400 group-hover:text-stone-600"}`}>
